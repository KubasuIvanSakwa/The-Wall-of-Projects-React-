...
function Nav() {
    return (
        <nav className=" p-3 flex flex-col h-[100vh] border-r border-r-[#A99985] w-[15rem] shadow-lg">
            ...
            <NavLink to="" className="text-[#F5F1ED] text-xl m-2">&rarr; &nbsp;&nbsp;&nbsp;Create</NavLink>
            <NavLink to="" className="text-[#F5F1ED] text-xl m-2">&rarr; &nbsp;&nbsp;&nbsp;Contribute</NavLink>
            <NavLink to="" className="text-[#F5F1ED] text-xl m-2">&rarr; &nbsp;&nbsp;&nbsp;Projects</NavLink>
